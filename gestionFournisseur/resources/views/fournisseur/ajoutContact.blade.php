...
<form action="{{ route('fournisseur.storeContact') }}" method="POST" id="form1">
    ...
    <div class="container-fluid bordure">
        <fieldset class="border p-3">
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    <button type="submit" name="action" value="save_another" {{-- onclick="submitForms()" --}}class="btn btn-warning">Enregistrer et ajouter un autre</button>
                    <button type="submit" name="action" value="save_next" {{-- onclick="submitForms()" --}} class="btn btn-secondary">Enregistrer et continuer</button>
                </div>
            </div>
        </fieldset>
    </div>
