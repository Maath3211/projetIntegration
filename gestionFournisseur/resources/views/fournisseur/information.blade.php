    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="custom-box">
                            ...
                            <br>
                                <form class="divContactForm"
                                    ...
                                    <button type="submit" class="btFake">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0076d5" class="bi bi-trash3" viewBox="0 0 16 16">
                                ...
                                <form class="divContactForm"
                                    ...
                                    @csrf
                                    <button type="submit" class="btFake">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0076d5" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                        </svg>
                                    </button>
                ...
                <form class="divContactForm" action="{{ route('fournisseur.addContactCreer', $fournisseur->id) }}" method="get">
                    @method('get')
                    <button type="submit" class="btn btn-secondary">
    ...
    <!-- Right side sections -->
        <div class="col-md-6">
            ...
            <div class="custom-box">
                ...
                <form action="fournisseur.finances.edit" method="GET">
                    @csrf
                    <div class="form-group">
                        <button type="submit" class="btn btn-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
