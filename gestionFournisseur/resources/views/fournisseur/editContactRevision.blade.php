...
@endphp
<form action="{{ route('fournisseur.updateContactRevision', $id) }}" method="POST" id="form1">
    @csrf
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Prénom" name="prenom" required
                        value="{{ $contact[$id]['prenom'] }}" id="prenom1">
                    @error('prenom')
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Fonction" name="fonction" required
                        value="{{ $contact[$id]['fonction'] }}" id="fonction1">
                    @error('fonction')
                        <span class="text-danger">{{ $message }}
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" placeholder="Courriel" name="courriel" required
                        value="{{ $contact[$id]['courriel'] }}" id="courriel1">
                    @error('courriel')
                        <span class="text-danger">{{ $message }}
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <select class="form-control" id="typeTelephone1" name="typeTelephone">
                        <option value="Bureau" @if ($contact[$id]['typeTelephone'] == 'bureau') selected @endif>Bureau</option>
                        <option value="Telecopieur" @if ($contact[$id]['typeTelephone'] == 'Telecopieur') selected @endif>
                            Télécopieur</option>
                        <option value="Cellulaire" @if ($contact[$id]['typeTelephone'] == 'Cellulaire') selected @endif>Cellulaire
                        </option>
                    </select>
                    @error('typeTelephone')
                        <span class="text-danger">{{ $message }}
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control telephones" placeholder="Téléphone"
                        name="telephone" required value="{{ $contact[$id]['telephone'] }}" id="telephone1">
                    @error('telephone1')
                        <span class="text-danger">{{ $message }}
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
            ...
            <div class="d-flex row justify-content-center">
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" placeholder="Poste" name="poste"
                        value="{{ $contact[$id]['poste'] }}" id="poste1">
                    @error('poste')
                        <span class="text-danger">{{ $message }}
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
