...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="custom-box">
                ...
                <form action="{{ route('fournisseur.identification') }}" method="GET">
                    @csrf
            ...
            <div class="custom-box">
                ...
                </svg> {{$coordonnees['typeTel']}} : {{$numero}} 
                @if($coordonnees['poste'])
                    Poste: {{$coordonnees['poste']}}
                @endif
                </p>
                @if($coordonnees['typeTel2'] || $numero2 || $coordonnees['poste2'])
                <p>
                    ...
                    @if($coordonnees['typeTel2'])
                        {{$coordonnees['typeTel2']}}
                    @endif
                    @if($numero2)
                        {{ $coordonnees['typeTel2'] ? ':' : '' }} {{$numero2}}
                    @endif
                    @if($coordonnees['poste2'])
                        Poste: {{$coordonnees['poste2']}}
                    @endif
                </p>
                @endif
                <form action="{{ route('fournisseur.coordonnees') }}" method="GET">
                    @csrf
                    <div class="form-group">
                        <button type="submit" class="btn btn-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
            ...
            <div class="custom-box">
                            ...
                            <div id="contactsList">
                                @foreach ($contacts as $contact)
                                    ...
                                    <div class="contact-item" style="display: {{ $loop->iteration <= 3 ? 'block' : 'none' }}">
                                        ...
                                        <form class="divContactForm" action="{{ route('fournisseur.suppContactSession', $id) }}"
                                            method="post">
                                            @method('delete')
                                            @csrf
                                        ...
                                        <form class="divContactForm" action="{{ route('fournisseur.editContactRevision', $id) }}"
                                            method="GET">
                                            @csrf
                                            <button type="submit" class="btFake">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0076d5"
                ...
                <div id="btsContacts">
                    <form class="divContactForm" action="{{ route('fournisseur.contact') }}"
                        method="get">
    ...
    <div class="col-md-6">
            <div class="custom-box">
                ...
                <p>{{ $unspscData['details'] }}</p>
                <form action="{{ route('fournisseur.UNSPSC') }}" method="GET">
                    @csrf
                    <div class="form-group">
                        <button type="submit" class="btn btn-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
            ...
            @endphp
                ...
                <form action="{{ route('fournisseur.RBQ') }}" method="GET">
                    @csrf
                    <div class="form-group">
                        <button type="submit" class="btn btn-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
             ...
             <br>
             <a href="{{ route('fournisseur.importation') }}"> <button class="btn btn-secondary">Suivant</button></a>
@endsection
