...
@section('contenu')
    ...
    <div class="container-fluid ">
        <div class="row" id="refusModeleDiv">
            <div class="col-md-6">
                            ...
                            <div class="modele" hidden>
                                ...
                                <select id="templateSelect" class="form-control" name="model_courriel">
                                    @foreach ($modelCourriels as $modelCourriel)
                                        <option value="{{ $modelCourriel->id }}"
                                            {{ $modelCourriel->nom === 'Refusé' ? 'selected' : '' }}>{{ $modelCourriel->nom }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="col-md-6">
                <div class="modele" id="divModele" hidden>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="custom-box">
                ...
                <p><span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    @role(['Gestionnaire', 'Administrateur'])
                        ...
                        @else
                            <form action="{{ route('fournisseur.storeDesactive', ['id' => $fournisseur->id]) }}"
                                method="POST">
                                @csrf
                                <div class="form-group">
            ...
            <div class="custom-box">
                ...
                <p><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-envelope-at-fill info" viewBox="0 0 16 16">
                        <path
                            ...
                            <div id="contactsList">
                                @foreach ($contacts as $contact)
                                    <div class="contact-item"
                                        style="display: {{ $loop->iteration <= 3 ? 'block' : 'none' }}">
                                        @if (!$loop->first)
                                        ...
                                        <li>
                                            ...
                                            <p><a href="mailto:{{ $contact->courriel }}">{{ $contact->courriel }}</a>
                                            </p>
                                        ...
                                        @role(['Gestionnaire', 'Administrateur'])
                                            ...
                                            <form class="divContactForm"
                                                ...
                                                <button type="submit" class="btFake">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        fill="#0076d5" class="bi bi-pencil-square me-2" viewBox="0 0 16 16">
                                                        <path
                                                            d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                        <path fill-rule="evenodd"
                                                            d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                ...
                <div class="custom-box">
                    ...
                    @foreach ($files as $file)
                        ...
                        <a
                            ...
                            <span class="file-info">{{ $file->nomFichier }} {{ $file->tailleFichier_KO }} Ko
